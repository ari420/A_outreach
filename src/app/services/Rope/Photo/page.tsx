    ...
    <main>
      ...
      <section className="sec2 flex flex-wrap py-8 2xl:py-12  xl:flex-nowrap *:w-full *:xl:w-[50%] overflow-hidden">
        <figure className="m-4 md:m-8 overflow-hidden rounded-[10px] transition-transform border">
          <Image
            className=" h-[250px] md:h-[400px] xl:h-[700px] 2xl:h-[850px] w-full object-cover"
            src="/imgtop.png"
            alt=""
            layout="reintrinsic"
            height={800}
        ...
        <div className="flex flex-wrap  *:flex content-center m-4 md:m-8  ">
          ...
          <h1 className=" my-2 text-black font-rubik w-full text-[40px]">
            PHOTO REPORTING CLEANING SOLUTIONS IN METRO VANCOUVER
          </h1>
          <p className="  my-2 text-black font-rubik w-full 2xl:text-[23px] text-justify">
            EXPERIENCE THE CLARITY WINDOW PHOTO REPORTING
          </p>
          <p className="  my-2 text-black font-rubik w-full 2xl:text-[23px] text-justify">
      ...
      <section className="sec3 flex flex-wrap py-8 2xl:py-12  xl:flex-nowrap *:w-full *:xl:w-[50%] overflow-hidden">
        ...
        >
          <figure className="m-4 md:m-8 overflow-hidden rounded-[10px] transition-transform ">
            <Image
              className=" h-[350px] md:h-[400px]  xl:h-[650px] 2xl:h-[750px] border w-full object-cover"
              src="/imgtop.png"
              alt=""
              layout="reintrinsic"
              height={800}
